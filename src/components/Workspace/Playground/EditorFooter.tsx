		...
		<div className='flex'>
			<div className='mx-5 my-[10px] flex justify-between w-full'>
				...
				<div className='ml-auto flex items-center space-x-4'>
					...
					<button
						className='px-3 py-1.5 font-medium items-center transition-all focus:outline-none inline-flex text-sm text-white bg-gradient-to-b from-yellow-500 to-yellow-700 hover:from-yellow-400 hover:to-yellow-600 rounded-lg'
						onClick={handleSubmit}
					>
						Submit
					</button>
